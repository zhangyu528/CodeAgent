...
export const searchFilesToolDefinition = {
  ...
  description: 'Search for a regex pattern in files within a directory. Supports regex patterns.',
  ...
  parameters: z.object({
    ...
    fileExtension: z
      .string()
      .describe('Optional file extension filter (e.g., ".ts", ".tsx").')
      .optional(),
    maxResults: z.number().describe('Maximum number of results to return.').optional().default(50),
  }),
};

export const searchFilesTool: AgentTool<any> = {
